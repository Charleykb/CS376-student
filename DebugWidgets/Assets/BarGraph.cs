...
var v = BarTransform.localPosition;
if (Min < 0)
{
signedDisplay = true;
v.x = width / 2;
BarTransform.localPosition = v;
}
}
/// <summary>
...
color
SetWidthPercent(val, color);
// TODO: Update the text to read: {name} : {value}
Text.text = $"{gameObject.name} : {val}";
}
/// <summary>
...
float scale = value;
var v2 = BarTransform.localScale;
if (signedDisplay)
{
scale /= 2;
}
v2.x = scale;
BarTransform.localScale = v2;
}
